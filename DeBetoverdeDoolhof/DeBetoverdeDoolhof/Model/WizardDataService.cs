    ...
    public class WizardDataService
    {
        ...
        public void Seed()
        {
            ...
            if (result != 4)
            {
                ...
                Wizard air = new Wizard(99, "yellow", "0,0", "/Resources/wizards/air.png");
                string sql = "Insert into Wizard (color, startPosition, image) values (@color, @startPosition, @image)";
                db.Query(sql, air);

                Wizard earth = new Wizard(99, "green", "6,6", "/Resources/wizards/earth.png");
                db.Query(sql, earth);

                Wizard fire = new Wizard(99, "red", "6,0", "/Resources/wizards/fire.png");
                db.Query(sql, fire);

                Wizard water = new Wizard(99, "blue", "0,6", "/Resources/wizards/water.png");
                db.Query(sql, water);
            }
        }
